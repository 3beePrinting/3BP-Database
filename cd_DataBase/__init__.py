...
class DatabaseApp(QMainWindow):
    ...
    from ._handle_printsettings import open_handle_printsetting_window, widget_printsettings, open_add_printsetting_window, open_modify_printsetting_window, save_printsettings, open_remove_printsettings_window, open_print_settings_window, assign_printsetting, confirm_assign, _on_print_settings_doubleclick
